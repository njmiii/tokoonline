...
class UserController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if (preg_match($pattern, $password)) {
            ...
            return redirect()->route('backend.v_user.index')->with('success', 'Data berhasil tersimpan');
        } else {
    ...
    public function destroy(string $id)
    {
        ...
        $user->delete();
        return redirect()->route('backend.v_user.index')->with('success', 'Data berhasil dihapus');
    }
